/*
  ...
  3. Purpose
    - Improves attachment handling for referrals
    - Provides better structure for attachment metadata
    - Enables proper attachment display in the UI
*/
