-- Role-aware scope for referral analytics:
--   Platform Owner -> whole network
--   Superuser      -> their entire hospital
--   Doctor         -> only their OWN referrals (created or received)
-- The personal clause is harmless for higher roles (it's a subset of what
-- their role clause already grants). Supersedes 20260624200000.
