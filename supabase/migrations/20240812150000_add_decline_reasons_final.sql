-- Final Corrected Migration to Add Decline Reasons
-- This version fully qualifies the column names in the RLS policies to prevent ambiguity.
...
-- RLS Policies for the new table (Corrected with fully qualified names)
CREATE POLICY "Users can view decline reasons for referrals they are part of"
    ...
    USING (
        EXISTS (
            ...
            WHERE r.id = referral_decline_reasons.referral_id -- Fully qualified
